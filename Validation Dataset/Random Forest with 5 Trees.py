...
RandomForest = RandomForestClassifier(n_estimators=5, min_samples_split=2, min_samples_leaf=1, max_features="sqrt", max_depth=27)
...
KFoldRandomForest = RandomForestClassifier(n_estimators=5, min_samples_split=2, min_samples_leaf=1, max_features="sqrt", max_depth=27)
