...
CarData = pd.read_csv("CombinedCarDataset.csv", usecols=["Timestamp", "Longitude", "Latitude", "Speed", "NetworkMode", "RSRP", "RSRQ", "State"])
...
CarDataWithScenario.to_csv("FinalCarDataset (Status Quo).csv", index=False)
