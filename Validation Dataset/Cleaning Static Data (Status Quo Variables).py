...
StaticData = pd.read_csv("CombinedStaticDataset.csv", usecols=["Timestamp", "Longitude", "Latitude", "Speed", "NetworkMode", "RSRP", "RSRQ", "State"])
...
StaticDataWithScenario.to_csv("FinalStaticDataset (Status Quo Variables).csv", index=False)
