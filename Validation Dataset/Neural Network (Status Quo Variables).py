...
DataFrame["NetworkMode"] = DataFrame["NetworkMode"].astype("category")
DataFrame["NetworkMode"] = DataFrame["NetworkMode"].cat.codes
...
UsedData = DataFrame[["Longitude", "Latitude", "RSRP", "RSRQ", "Scenario Category", "NetworkMode"]]
...
TrainLabels = Train.pop("NetworkMode")
TestLabels = Test.pop("NetworkMode")
ValidationLabels = Validation.pop("NetworkMode")
...
X = DataFrame[["Longitude", "Latitude", "RSRP", "RSRQ", "Scenario Category", "NetworkMode"]]
Y = X.pop("NetworkMode")
