...
#Reading CSV
DataFrame = pd.read_csv("Filtered Throughput Dataset.csv", na_values=MissingValues)

#Dropping index column
DataFrame = DataFrame.drop("Unnamed: 0", axis=1)

#Filtering the data to only display records for Date 1
Date1FilteredData = DataFrame.loc[DataFrame["Date"] == "04.01.2021"]

#Printing a summary of the Date 1 dataset
print(Date1FilteredData)

#Sorting Date 1 values by time
...
#Forward-filling the Date 1 data to fill in any gaps
Date1FilledData = Date1SortedData.ffill(axis = 0)

#Printing a summary of the forward-filled Date 1 data
print(Date1FilledData)

#Writing final Date 1 data to a CSV
Date1FilledData.to_csv("Date 1 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 2
Date2FilteredData = DataFrame.loc[DataFrame["Date"] == "05.01.2021"]

#Printing a summary of the Date 2 dataset
print(Date2FilteredData)

#Sorting Date 2 values by time
Date2SortedData = Date2FilteredData.sort_values(by="Time", ascending=True)

#Printing a summary of the sorted dataset
print(Date2SortedData)

#Forward-filling the Date 2 data to fill in any gaps
Date2FilledData = Date2SortedData.ffill(axis = 0)

#Printing a summary of the forward-filled Date 2 data
print(Date2FilledData)

#Writing final Date 2 data to a CSV
Date2FilledData.to_csv("Date 2 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 3
Date3FilteredData = DataFrame.loc[DataFrame["Date"] == "13.12.2020"]

#Printing a summary of the Date 3 dataset
print(Date3FilteredData)

#Sorting Date 3 values by time
Date3SortedData = Date3FilteredData.sort_values(by="Time", ascending=True)

#Printing a summary of the sorted dataset
print(Date3SortedData)

#Forward-filling the Date 3 data to fill in any gaps
...
Date6FilledData.to_csv("Date 6 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 7
Date7FilteredData = DataFrame.loc[DataFrame["Date"] == "24.01.2021"]

#Printing a summary of the Date 7 dataset
print(Date7FilteredData)

#Sorting Date 7 values by time
...
Date7FilledData.to_csv("Date 7 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 8
Date8FilteredData = DataFrame.loc[DataFrame["Date"] == "08.01.2021"]

#Printing a summary of the Date 8 dataset
print(Date8FilteredData)

#Sorting Date 8 values by time
...
Date8FilledData.to_csv("Date 8 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 9
Date9FilteredData = DataFrame.loc[DataFrame["Date"] == "16.12.2020"]

#Printing a summary of the Date 9 dataset
print(Date9FilteredData)

#Sorting Date 9 values by time
...
Date9FilledData.to_csv("Date 9 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 10
...
#Sorting Date 10 values by time
...
Date10FilledData.to_csv("Date 10 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 11
...
#Sorting Date 11 values by time
...
Date11FilledData.to_csv("Date 11 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 12
...
#Sorting Date 12 values by time
...
Date12FilledData.to_csv("Date 12 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 13
...
#Sorting Date 13 values by time
...
Date13FilledData.to_csv("Date 13 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 14
...
#Sorting Date 14 values by time
...
Date14FilledData.to_csv("Date 14 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 15
...
#Sorting Date 15 values by time
...
Date15FilledData.to_csv("Date 15 Cleaned Throughput Data.csv")

#Filtering the data to only display records for Date 16
...
#Sorting Date 16 values by time
...
Date16FilledData.to_csv("Date 16 Cleaned Throughput Data.csv")

#Combining all 16 days' worth of data into one DataFrame
...
CombinedDataset.to_csv("Final Throughput Dataset.csv")
