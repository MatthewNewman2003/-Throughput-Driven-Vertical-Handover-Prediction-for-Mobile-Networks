...
#Declaring folder path of car dataset files (This will differ if executed on a different computer, apart from the final "car" part)
FolderPath = r'C:\Users\Matthew Newman\Documents\University of Gloucestershire\BSc Hons Computer Science\Level 6\CT6039 Dissertation\Validation Dataset\Dataset\car'
...
CombinedDataFrame.drop(["Unnamed: 0.1"], inplace=True, axis=1)

#Writing combined dataset to a CSV file
CombinedDataFrame.to_csv(os.path.join(FolderPath, "CombinedCarDataset.csv"), index=False)
