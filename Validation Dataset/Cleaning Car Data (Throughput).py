...
CarData = pd.read_csv("CombinedCarDataset.csv", usecols=["Timestamp", "Longitude", "Latitude", "Speed", "NetworkMode", "DL_bitrate", "UL_bitrate", "State"])
...
CarDataWithScenario.to_csv("FinalCarDataset (Throughput).csv", index=False)
