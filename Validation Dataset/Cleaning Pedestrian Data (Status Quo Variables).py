...
PedestrianData = pd.read_csv("CombinedPedestrianDataset.csv", usecols=["Timestamp", "Longitude", "Latitude", "Speed", "NetworkMode", "RSRP", "RSRQ", "State"])
...
PedestrianDataWithScenario.to_csv("FinalPedestrianDataset (Status Quo).csv", index=False)
