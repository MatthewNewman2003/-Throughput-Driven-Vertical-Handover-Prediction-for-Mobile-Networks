...
#Declaring folder path of static dataset files (This will differ if executed on a different computer, apart from the final "static" part)
FolderPath = r'C:\Users\Matthew Newman\Documents\University of Gloucestershire\BSc Hons Computer Science\Level 6\CT6039 Dissertation\Validation Dataset\Dataset\static'
...
CombinedDataFrame.to_csv(os.path.join(FolderPath, "CombinedStaticDataset.csv"), index=False)
