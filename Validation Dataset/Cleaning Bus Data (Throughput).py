...
BusData = pd.read_csv("CombinedBusDataset.csv", usecols=["Timestamp", "Longitude", "Latitude", "Speed", "NetworkMode", "DL_bitrate", "UL_bitrate", "State"])
...
BusDataWithScenario.to_csv("FinalBusDataset (Throughput).csv", index=False)
