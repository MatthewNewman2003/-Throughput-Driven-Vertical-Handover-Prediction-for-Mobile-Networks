...
DataFrame = pd.read_csv("Final Combined Dataset.csv")
...
X = DataFrame[["GPS Long", "GPS Lat", "SS-RSRP", "SS-RSRQ", "SS-SINR", "Current Netw. DL", "Current Netw. UL", "Mean Netw. DL", "Mean Netw. UL", "Current Netw. DL Avg", "Current Netw. DL Max", "Current Netw. UL Avg", "Current Netw. UL Max", "Scenario Category"]]
...
pickle.dump(RandomForest, open("RandomForestCombined.sav", "wb"))
