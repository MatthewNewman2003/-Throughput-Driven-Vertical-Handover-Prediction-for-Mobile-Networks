...
#Declaring folder path of pedestrian dataset files (This will differ if executed on a different computer, apart from the final "pedestrian" dataset)
FolderPath = r'C:\Users\Matthew Newman\Documents\University of Gloucestershire\BSc Hons Computer Science\Level 6\CT6039 Dissertation\Validation Dataset\Dataset\pedestrian'
...
CombinedDataFrame.to_csv(os.path.join(FolderPath, "CombinedPedestrianDataset.csv"), index=False)
