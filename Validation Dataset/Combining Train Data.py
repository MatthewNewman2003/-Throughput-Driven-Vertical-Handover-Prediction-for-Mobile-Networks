...
#Declaring folder path of train dataset files (This will differ if executed on a different computer, apart from the final "train" part)
FolderPath = r'C:\Users\Matthew Newman\Documents\University of Gloucestershire\BSc Hons Computer Science\Level 6\CT6039 Dissertation\Validation Dataset\Dataset\train'
...
CombinedDataFrame.to_csv(os.path.join(FolderPath, "CombinedTrainDataset.csv"), index=False)
