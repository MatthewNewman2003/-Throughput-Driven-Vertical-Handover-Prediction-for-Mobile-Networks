...
PedestrianData = pd.read_csv("CombinedPedestrianDataset.csv", usecols=["Timestamp", "Longitude", "Latitude", "Speed", "NetworkMode", "RSRP", "RSRQ", "DL_bitrate", "UL_bitrate", "State"])
...
PedestrianDataWithScenario.to_csv("FinalPedestrianDataset.csv", index=False)
