...
TrainData = pd.read_csv("CombinedTrainDataset.csv", usecols=["Timestamp", "Longitude", "Latitude", "Speed", "NetworkMode", "RSRP", "RSRQ", "DL_bitrate", "UL_bitrate", "State"])
...
TrainDataWithScenario.to_csv("FinalTrainDataset.csv", index=False)
