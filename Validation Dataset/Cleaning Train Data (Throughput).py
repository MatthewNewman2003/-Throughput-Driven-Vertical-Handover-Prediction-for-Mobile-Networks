...
TrainData = pd.read_csv("CombinedTrainDataset.csv", usecols=["Timestamp", "Longitude", "Latitude", "Speed", "NetworkMode", "DL_bitrate", "UL_bitrate", "State"])
...
TrainDataWithScenario.to_csv("FinalTrainDataset (Throughput).csv", index=False)
