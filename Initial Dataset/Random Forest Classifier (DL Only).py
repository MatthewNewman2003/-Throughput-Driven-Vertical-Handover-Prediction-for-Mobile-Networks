...
X = DataFrame[["GPS Long", "GPS Lat", "Current Netw. DL", "Mean Netw. DL", "Current Netw. DL Avg", "Current Netw. DL Max", "Scenario Category"]]
...
pickle.dump(RandomForest, open("RandomForestDLOnly.sav", "wb"))
