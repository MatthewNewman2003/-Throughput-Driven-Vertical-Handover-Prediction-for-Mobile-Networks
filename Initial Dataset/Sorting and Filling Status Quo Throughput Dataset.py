...
#Reading CSV
DataFrame = pd.read_csv("Filtered Status Quo Throughput Dataset.csv", na_values=MissingValues)

#Dropping index column
DataFrame = DataFrame.drop("Unnamed: 0", axis=1)

#Filtering dataset to only show data for Date 1
...
Date1FilledData.to_csv("Date 1 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 2
...
Date2FilledData.to_csv("Date 2 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 3
...
Date3FilledData.to_csv("Date 3 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 4
...
Date4FilledData.to_csv("Date 4 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 5
...
Date5FilledData.to_csv("Date 5 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 6
...
Date6FilledData.to_csv("Date 6 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 7
...
Date7FilledData.to_csv("Date 7 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 8
...
Date8FilledData.to_csv("Date 8 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 9
...
Date9FilledData.to_csv("Date 9 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 10
...
Date10FilledData.to_csv("Date 10 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 11
...
Date11FilledData.to_csv("Date 11 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 12
...
Date12FilledData.to_csv("Date 12 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 13
...
Date13FilledData.to_csv("Date 13 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 14
...
#Forward-filling the Date 14 data to fill in any gaps
...
Date14FilledData.to_csv("Date 14 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 15
...
Date15FilledData.to_csv("Date 15 Cleaned Status Quo Throughput Data.csv")

#Filtering dataset to only show data for Date 16
...
#Writing final Date 15 dataset to a CSV file
Date16FilledData.to_csv("Date 16 Cleaned Status Quo Throughput Data.csv")
...
CombinedDataset.to_csv("Final Status Quo Throughput Dataset.csv")
