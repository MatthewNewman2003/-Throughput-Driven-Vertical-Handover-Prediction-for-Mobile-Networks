...
DataFrame = pd.read_csv("Filtered Combined Dataset (All).csv")
...
X = DataFrame[["Longitude", "Latitude", "Speed", "RSRP", "RSRQ", "DL_bitrate", "UL_bitrate", "State Category", "Scenario Category"]]
...
KFoldDummy = DummyClassifier(strategy="most_frequent")
