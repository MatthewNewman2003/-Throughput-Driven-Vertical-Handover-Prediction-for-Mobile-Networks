...
X = DataFrame[["GPS Long", "GPS Lat", "Current Netw. UL", "Mean Netw. UL", "Current Netw. UL Avg", "Current Netw. UL Max", "Scenario Category"]]
...
pickle.dump(RandomForest, open("RandomForestULOnly.sav", "wb"))
